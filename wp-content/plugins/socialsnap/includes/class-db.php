<?php
/**
 * Social Snap Database class.
 *
 * Based on Easy Digital Downloads DB class.
...
abstract class SocialSnap_DB {
	...
	public function add( $data, $type = '' ) {
		...
		do_action( 'socialsnap_pre_insert_' . $type, $data );
		...
		do_action( 'socialsnap_post_insert_' . $type, $wpdb->insert_id, $data );
	...
	public function update( $row_id, $data = array(), $where = '', $type = '' ) {
		...
		do_action( 'socialsnap_post_update_' . $type, $data );
	...
	public function delete( $row_id = 0 ) {
		...
		do_action( 'socialsnap_post_delete', $row_id );
