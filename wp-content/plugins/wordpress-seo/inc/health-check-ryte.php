...
class WPSEO_Health_Check_Ryte extends WPSEO_Health_Check {
	...
	protected function is_not_indexable_response() {
		...
		$this->actions = sprintf(
			/* translators: %1$s: Opening tag of the link to the Yoast help center, %2$s: Link closing tag. */
			esc_html__( '%1$sLeia Mais about troubleshooting search engine visibility.%2$s', 'wordpress-seo' ),
	...
	protected function unknown_indexability_response() {
		...
		$alert_text    = esc_html__(
			...
			%2$sLeia Mais about troubleshooting search engine visibility%3$s.',
			'wordpress-seo'
		);
