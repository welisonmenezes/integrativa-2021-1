...
$banner_subtitle   = get_theme_mod( 'university_zone_banner_subtitle', __( 'subtitle here', 'university-zone' ) );
...
$read_more      = get_theme_mod( 'education_zone_banner_read_more', __( 'Leia Mais', 'university-zone' ) );
                        ...
                        <div class="container">
                            ...
                            <div class="text">
                                ...
                                <?php if( $banner_title ){ ?>
                                    ...
                                    <h3 class="title"><?php echo esc_html( $banner_subtitle ); ?></h3>
        ...
        <div class="banner-text">
            ...
            <div class="container">
                ...
                <div class="text">
                    ...
                    if ( $banner_subtitle ) echo '<h3 class="title">'. esc_html( $banner_subtitle ).'</h3>';
