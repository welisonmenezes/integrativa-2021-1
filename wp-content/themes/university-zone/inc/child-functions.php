...
function university_zone_banner_section( $wp_customize ){
    ...
    $wp_customize->add_setting(
        ...
        'university_zone_banner_subtitle',

        array(

            'default'           => __( 'subtitle here', 'university-zone' ),
    ...
    $wp_customize->selective_refresh->add_partial( 'university_zone_banner_subtitle', array(

        'selector'        => '.banner .banner-text .title',

        'render_callback' => 'university_zone_banner_subtitle',
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'label'           => __( 'Banner Subtitle', 'university-zone' ),
...
function university_zone_banner_ac( $control ){
    ...
    if ( $control_id == 'university_zone_banner_subtitle' && $banner == 'static_banner_cta' ) return true;
...
function university_zone_banner_subtitle(){

    return esc_html( get_theme_mod( 'university_zone_banner_subtitle',__( 'subtitle here','university-zone' ) ) );
