                            ...
                            <?php if( $email || $phone ){
                                ...
                                if( $phone ){ ?>
                                   ...
                                   <div class="phone">
                                       ...
                                       <span class="label"><?php esc_html_e( 'WhatsApp','university-zone' ); ?></span>

                                       <a href="<?php echo esc_url( 'https://api.whatsapp.com/send?phone=55'. preg_replace('/[^\d+]/', '', $phone ) ); ?>" target="_blank" class="tel-link"><?php echo esc_html( $phone ); ?></a>
